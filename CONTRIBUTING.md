# Contributing to Astroroute

Thanks for your interest in contributing to Astroroute! This guide will help you get started.
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/ezrahel/astroroute.git
   cd astroroute
   ```
