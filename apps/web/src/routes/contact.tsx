...
function ContactPage() {
  ...
  const emails = [
    { label: "Support", email: "support@astroroute.dev", icon: Mail, description: "Questions & help" },
    { label: "Partnerships", email: "hey@astroroute.dev", icon: Handshake, description: "Business inquiries" },
    { label: "Security", email: "security@astroroute.dev", icon: Shield, description: "Report vulnerabilities" },
  ];
