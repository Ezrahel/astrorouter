          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p className="text-white/60 leading-relaxed">
                By accessing or using AstroRoute's services, website, CLI tools, or
            ...
            <section className="mb-12">
              ...
              <p className="text-white/60 leading-relaxed">
                AstroRoute provides secure tunneling services that allow developers
            ...
            <section className="mb-12">
              ...
              <p className="text-white/60 leading-relaxed">
                ...
                owned by AstroRoute and protected by intellectual property laws. You
            ...
            <section className="mb-12">
              ...
              <p className="text-white/60 leading-relaxed">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, ASTROROUTE SHALL NOT BE
            ...
            <section className="mb-12">
              ...
              <p className="text-white/60 leading-relaxed">
                You agree to indemnify and hold harmless AstroRoute, its officers,
            ...
            <section className="mb-12">
              ...
              <p className="text-white/60 leading-relaxed">
                ...
                <a
                  href="mailto:legal@astroroute.dev"
                  className="text-accent hover:underline"
                >
                  legal@astroroute.dev
                </a>
                .
              </p>
            </section>
