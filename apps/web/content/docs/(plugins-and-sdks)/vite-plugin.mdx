...
The `@astroroute/vite` plugin automatically creates an OutRay tunnel when your Vite development server starts, giving you a public URL to share your local development environment.

## Installation

```bash
npm install @astroroute/vite
```

```bash
pnpm add @astroroute/vite
```

```bash
yarn add @astroroute/vite
```
